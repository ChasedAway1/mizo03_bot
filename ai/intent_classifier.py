...
=======
"""
intent_classifier.py — Классификация намерений пользователя через LLM.

Определяет:
  - категорию (svo / large_family / laws / common / unknown)
  - подтему (docs / right / howto / law / conditions / general)
  - меру СВО (1 / 2 / 3 / None)
...
@dataclass
class Intent:
    category: str            # svo | large_family | laws | common | unknown
    subtopic: str            # docs | right | howto | law | conditions | general
    measure_id: Optional[int]  # 1, 2, 3 — только для svo
    confidence: float        # 0.0 – 1.0
    raw_question: str        # исходный вопрос
>>>>>>> 4b55dc7883198cb626e17712fddf1c30aa32cf26
